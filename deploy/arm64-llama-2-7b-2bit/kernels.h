...
extern "C"
 ...
 int32_t preprocessor_t1_int8_m8192_k11008_n1_b2(void* B, void* LUT_Scales, void* LUT_Biases, void* QLUT);inline int qgemm_lut_int8(int m, int k, int n, int b, void* A, void* LUT, void* Scales, void* LUT_Scales, void* LUT_Biases, void* C) {
    ...
    if (m == 1024 && k == 4096 && n == 1 && b == 2) return qgemm_lut_t1_int8_m1024_k4096_n1_b2(A, LUT, Scales, LUT_Scales, LUT_Biases, C);

    if (m == 512 && k == 4096 && n == 1 && b == 2) return qgemm_lut_t1_int8_m512_k4096_n1_b2(A, LUT, Scales, LUT_Scales, LUT_Biases, C);

    if (m == 1024 && k == 11008 && n == 1 && b == 2) return qgemm_lut_t1_int8_m1024_k11008_n1_b2(A, LUT, Scales, LUT_Scales, LUT_Biases, C);
